...
<div class="container py-4">
    ...
    <div class="mb-4">
        ...
        <div class="d-flex align-items-center gap-2 mb-1">
            ...
            <!-- Tombol Modal Info -->
            <button type="button" class="btn btn-sm btn-outline-primary rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width:30px;height:30px" data-bs-toggle="modal" data-bs-target="#modalInfoRating" title="Panduan Penilaian">
                <i class="fas fa-info fw-bold"></i>
            </button>
        </div>
        <p class="text-muted mb-0">Aktivitas: <strong class="text-primary">{{ $activity->title }}</strong> | Kelompok: <strong>{{ $group->name }}</strong></p>
    </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="ratings[{{ $member->id_user }}][score]" class="form-control fw-bold" min="0" max="100" required placeholder="0" value="{{ old('ratings.'.$member->id_user.'.score', $rating->score ?? '') }}">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <textarea name="ratings[{{ $member->id_user }}][comment]" class="form-control" rows="1" maxlength="1000" placeholder="Kinerja teman ini...">{{ old('ratings.'.$member->id_user.'.comment', $rating->comment ?? '') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="alert alert-secondary border-0 shadow-sm rounded-4">Tidak ada teman kelompok yang dapat dinilai.</div>
                @endforelse
            </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="ratings[{{ $selfId }}][score]" class="form-control border-success fw-bold text-success" min="0" max="100" required placeholder="0" value="{{ old('ratings.'.$selfId.'.score', $selfRating->score ?? '') }}">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <textarea name="ratings[{{ $selfId }}][comment]" class="form-control border-success" rows="1" maxlength="1000" placeholder="Tugas yang saya kerjakan...">{{ old('ratings.'.$selfId.'.comment', $selfRating->comment ?? '') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 bg-light shadow-sm rounded-4 mt-4">
                        <div class="card-body p-4 text-center">
                            <p class="text-muted small mb-3">
                                <i class="fas fa-info-circle text-primary me-1"></i> Pastikan total seluruh poin yang Anda bagikan (Teman + Diri Sendiri) berjumlah tepat <strong>100 Poin</strong>.
                            </p>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded-4 shadow border-0">
            ...
            <div class="modal-body p-4">
                <p class="mb-3">
                    Anda diberikan total <strong>100 Poin</strong> untuk dibagikan kepada <strong>seluruh anggota kelompok</strong>, termasuk diri Anda sendiri.
                </p>
                
                <div class="bg-light p-3 rounded border mb-3">
                    <p class="fw-bold text-dark mb-2">Contoh Skenario (1 kelompok 2 orang):</p>
                    <ul class="text-muted small mb-0 ps-3">
                        <li class="mb-1">Jika Anda berdua bekerja sama dengan adil, bagikan <strong>50 Poin</strong> untuk teman dan <strong>50 Poin</strong> untuk Anda.</li>
                        <li>Jika Anda merasa mengerjakan tugas jauh lebih banyak, Anda bisa memberi nilai misalnya <strong>70 Poin</strong> untuk diri sendiri dan <strong>30 Poin</strong> untuk teman.</li>
                        <li>Jika Anda merasa mengerjakan tugas jauh lebih sedikit secara sadar, Anda bisa memberi nilai misalnya <strong>30 Poin</strong> untuk diri sendiri dan <strong>70 Poin</strong> untuk teman.</li>
                    </ul>
                </div>
