        ...
        <div class="modal-content rounded-4">
            ...
            <div class="modal-body">
                ...
                <section class="mb-4">
                    ...
                    <img src="{{ asset('img/info/tambah-kelas.png') }}" class="img-fluid rounded border" alt="Tambah Kelas">
                </section>
                ...
                <section class="mb-4">
                    ...
                    <img src="{{ asset('img/info/gabung-kelas.png') }}" class="img-fluid rounded border" alt="Gabung Kelas">
                </section>
                ...
                <section>
                    ...
                    <img src="{{ asset('img/info/edit-kelas.png') }}" class="img-fluid rounded border" alt="Edit Kelas">
                </section>
            </div>
